#ifndef TEST_TR5_STRUCTS_H
#define TEST_TR5_STRUCTS_H

// here are the structs/enums/unions that haven't been sorted yet
...
struct TapCtrllerData {
    ...
    union _85fake data; // size=6, offset=2
};
struct MultiTapData {
...
struct ControllerPacket {
    unsigned char transStatus; // size=0, offset=0
    unsigned char dataFormat; // size=0, offset=1
    union _76fake data; // size=32, offset=2
};
